...
const YogyakartaNonCovid = () => {
    ...
    const fetchData = async () => {
        const request = await axios.get('https://rs-bed-covid-api.vercel.app/api/get-hospitals?provinceid=34prop&cityid=3471&type=2');
        return request;
    }
...
export default YogyakartaNonCovid;