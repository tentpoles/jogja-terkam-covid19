...
const YogyakartaCovid = () => {
    ...
    const fetchData = async () => {
        const request = await axios.get('https://rs-bed-covid-api.vercel.app/api/get-hospitals?provinceid=34prop&cityid=3471&type=1');           
        return request;
    }
...
export default YogyakartaCovid;
