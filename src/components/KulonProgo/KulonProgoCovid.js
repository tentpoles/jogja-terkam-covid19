...
const KulonProgoCovid = () => {
    ...
    const fetchData = async () => {
        const request = await axios.get('https://rs-bed-covid-api.vercel.app/api/get-hospitals?provinceid=34prop&cityid=3401&type=1');           
        return request;
    }
                ...
                <HospitalList>
                    ...
                    {hospitals && hospitals.map((hospital, index) => 
                        <HospitalCard key={index}>
                            <Link to={`/hospitalid=${hospital.id}&type=1`}>
                                    ...
                                    <HospitalDesc>
                                        {
                                            ...
                                            :
                                            <h4 className='bed-available'>Tersedia {hospital.bed_availability} Kamar</h4>
                                        }
...
export default KulonProgoCovid;
