...
const SlemanNonCovid = () => {
    ...
    const fetchData = async () => {
        const request = await axios.get('https://rs-bed-covid-api.vercel.app/api/get-hospitals?provinceid=34prop&cityid=3404&type=2');           
        return request;
    }
