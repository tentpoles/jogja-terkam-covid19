        ...
        <>
            <HomeInformationContainer className='animate__animated animate__fadeInUp'>
                <Information className='minimize' id='information-container'>
                    ...
                    <p className='text-information'>Hampir 2 tahun belakangan, dunia diharuskan untuk hidup berdampingan dengan Pandemi Covid-19, melansir dari data Satgas Covid-19 pada laman covid19.go.id, zona merah corona di Indonesia per tanggal 19 September 2021 sudah mencapai nol. Meski akhir-akhir ini mulai terlihat mereda, jangan lengah dan menganggap semuanya sudah kembali normal, pandemi belum usai! Banyak negara termasuk Indonesia telah bersepakat untuk menyiapkan langkah-langkah agar bisa hidup berdampingan dengan virus corona, transisi dan adaptasi sudah semestinya dipersiapkan dengan tetap mengedepankan keselamatan jiwa.<br /><br />Upaya preventif yang dilakukan pemerintah adalah dengan melakukan pengawasan ketat di jalur antar wilayah tingkat daerah hingga provinsi meliputi stasiun, bandara, pelabuhan dan pos lintas perbatasan. Kemenko Luhut mengklaim bahwa selama diberlakukan  Pemberlakuan Pembatasan Kegiatan Masyarakat (PPKM) penanganan Covid-19 sangat-sangat terkendali serta pelaksanaan penanganan Covid-19 baik-baik saja.<br /><br />Sampai saat ini belum ada solusi terbaik selain disiplin menjalankan protokol kesehatan karena PPKM akan terus diperpanjang seminggu sekali! Saatnya melakukan penanganan mandiri, kondisi seperti ini akan berlangsung sampai Pandemi Covid-19 benar-benar terkendali oleh Pemerintah Indonesia.</p>
